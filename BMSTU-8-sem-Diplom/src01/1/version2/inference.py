...
labelencode = pickle.load(open('/Users/dangnguyen/Documents/Project/Text-Classification/labelencoder_fitted.pkl', 'rb'))

# Loading TF-IDF Vectorizer
Tfidf_vect = pickle.load(open('/Users/dangnguyen/Documents/Project/Text-Classification/Tfidf_vect_fitted.pkl', 'rb'))

# Loading models
SVM = pickle.load(open('/Users/dangnguyen/Documents/Project/Text-Classification/svm_trained_model.sav', 'rb'))
Naive = pickle.load(open('/Users/dangnguyen/Documents/Project/Text-Classification/nb_trained_model.sav', 'rb'))
